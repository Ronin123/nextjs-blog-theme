...
import {
  getNextPoemBySlug,
  getPoemBySlug,
  getPreviousPoemBySlug,
  poemFilePaths,
} from '../../utils/mdx-utils-poems';
...
export const getStaticProps = async ({ params }) => {
  ...
  const { mdxSource, data } = await getPoemBySlug(params.slug);
  const prevPoem = getPreviousPoemBySlug(params.slug);
  const nextPoem = getNextPoemBySlug(params.slug);
